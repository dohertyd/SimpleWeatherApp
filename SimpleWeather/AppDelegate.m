...
@property (strong, nonatomic)  CoreDataStack * cds;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //NSManagedObjectContext * context = [self.cds managedObjectContext];
    
    // Store MOC to global data
    [Globals setCds:self.cds];
